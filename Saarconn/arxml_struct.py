...
def _generate_children(parent, f, level, var_counts, parent_var_name=None):
    ...
    for child in parent:
        ...
        base_var_name = tag.replace('-', '_').lower()  # Convert to lowercase and replace hyphens with underscores
        ...
        if base_var_name in var_counts:
            ...
            var_counts[base_var_name] = 1
        var_name = f"{base_var_name}{var_counts[base_var_name]}"
...
if __name__ == '__main__':
    ...
    output_python = "generated_script2.py"  # Replace with the desired output file name

...
def CreateSwcs():
    ...
    for index, row in valid_swcs.iterrows():
        ...
        if swc_type == 'ApplicationSwComponentType':
            ...
            ComplexDeviceDriverSwComponentType(row)  # Call the starter function for ComplexDeviceDriverSwComponentType
        elif swc_type == 'EcuAbstractionSwComponentType':
            EcuAbstractionSwComponentType(row)  # Call the starter function for EcuAbstractionSwComponentType
        elif swc_type == 'NvBlockSwComponentType':
            NvBlockSwComponentType(row)  # Call the starter function for NvBlockSwComponentType
        elif swc_type == 'ParameterSwComponentType':
            ParameterSwComponentType()  # Call the starter function for ParameterSwComponentType
        elif swc_type == 'SensorActuatorSwComponentType':
            SensorActuatorSwComponentType(row)  # Call the starter function for SensorActuatorSwComponentType
        elif swc_type == 'ServiceProxySwComponentType':
            ServiceProxySwComponentType(row)  # Call the starter function for ServiceProxySwComponentType
        elif swc_type == 'ServiceSwComponentType':
            ServiceSwComponentType(row)  # Call the starter function for ServiceSwComponentType
        else:
...
def ApplicationSwComponentType(row):
    ...
    # CurrentInternalBehaviors.handleTerminationAndRestart=SystemDeskEnums.HandleTerminationAndRestartEnum(Handle_Termination_And_Restart)
    CurrentInternalBehaviors.SupportsMultipleInstantiation = Supports_Multiple_Instantiation


    runnable_name = row["Runnable Name"]
...
def ComplexDeviceDriverSwComponentType(row):
    """
...
def EcuAbstractionSwComponentType(row):
...
def NvBlockSwComponentType(row):
...
def ParameterSwComponentType(row):
...
def SensorActuatorSwComponentType(row):
...
def ServiceProxySwComponentType(row):
...
def ServiceSwComponentType(row):

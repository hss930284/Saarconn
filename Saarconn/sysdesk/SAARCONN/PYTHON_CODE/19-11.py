...
def Get_table_started_cell_number():
    ...
    table2_headers = ["Sr. No.", "Port Name", "Port Type", "Interface Name", "Interface Type", "DataElement abcd", "Argument", "Application Data Type", "Description"]
...
def ApplicationSwComponentType():
    ...
    CurrentSWC = CurrentApplSWCPkg.Elements.AddNewApplicationSwComponentType(current_sheet.iloc[2, 2])  #software component name  
    CurrentInternalBehaviors = CurrentSWC.InternalBehaviors.AddNew(current_sheet.iloc[2, 4])   #Internal Behavior

...
def ReadUserDefinedExcel():
    # Declare global variables to be used across the function
    ...
    # Create a pandas ExcelFile object for easier data manipulation
    xls = pd.ExcelFile(Input_Excel_File)
    
    # Assign each worksheet to a corresponding variable for easy access
    Project_Info = workbook.worksheets[0]  # First worksheet for project information
    SWC_Info = workbook.worksheets[1]       # Second worksheet for software component information
    IB_data = workbook.worksheets[2]        # Third worksheet for integration block data
    Ports = workbook.worksheets[3]          # Fourth worksheet for ports information
    ADT_Primitive = workbook.worksheets[4]  # Fifth worksheet for primitive ADT information
    ADT_Composite = workbook.worksheets[5]  # Sixth worksheet for composite ADT information
...
def CreateSwcs():
    ...
    # Check the value of B2 and call the corresponding function based on the software component type
    if value_B2 == 'ApplicationSwComponentType':
        ...
        # If the value does not match any known component type, print an error message
...
def CreateOtherIBElements(CurrentInternalBehaviors):
    # Read columns from IB_data for various parameters
    ...
    # Iterate through the parameters read from the data
    for a, b, c, d, e, f, g in zip(IBVariableType, IBVariableName, ApplicationDataTypeName, Initvalue, AccessingRunnable, SwCalibrationAccess, SwImplementationPolicy):
        ...
        # Check the type of IB element and create it accordingly
        if a == 'SharedParameter':
            ...
            # Set software implementation policy and calibration access
            ...
            # Create application primitive data type and associated components
            ...
            # Create a new per-instance parameter
            ...
            # Create a new implicit inter-runnable variable
            ...
            # Create a new explicit inter-runnable variable
            ...
            # Create a new per-instance memory
            ...
            # Create a new AR typed per-instance memory
            ...
            # Handle the case where the IB element type is not recognized
...
def Main():
    ...
    ReadUserDefinedExcel()  # Read user-defined data from an Excel file
